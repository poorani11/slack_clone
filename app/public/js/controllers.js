slackClone.controller('AppCtrl',
    function($rootScope, $scope, $window, $firebaseSimpleLogin) {
        var ref = new Firebase('https://angular-slackclone.firebaseio.com/');
...
slackClone.controller('Toolbar', ['$scope', 'Window',
...
slackClone.controller('AuthCtrl', function($rootScope, $scope) {
...
slackClone.controller('HomeCtrl', function($rootScope, $scope) {
